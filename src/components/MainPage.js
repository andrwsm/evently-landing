...
const features = [
  {
    ...
    description:
      "Your profits are your own. Keep all of what you earn from your events with no hidden fees.",
    icon: CustomIcons.find((icon) => icon.name === "MoneyIcon").component,
  },
  {
    name: "Easy To Use.",
    description:
      "Our platform designed to be easy to use and easy to understand. No need to be a tech wizard.",
  ...
  return (
    <div className="relative overflow-hidden bg-gradient-to-b from-slate-50 to-white py-24 sm:py-32">
      ...
      <div
        ...
        style={{
          backgroundImage: `url(${EventlyIcon})`,
          backgroundSize: "70%",
          backgroundPosition: "right 20% top -10%",
        }}
      />
